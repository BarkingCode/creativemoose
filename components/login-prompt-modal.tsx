...
export function LoginPromptModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[#1a1517] border-white/10 text-white max-w-md mx-auto rounded-3xl p-0 overflow-hidden">
        {/* Header */}
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <Button
                    ...
                    disabled={loading}
                    variant="outline"
                    className="w-full h-12 bg-black text-white border-white/20 hover:bg-gray-900 rounded-xl font-medium"
                  >
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#1a1517] text-white/40">
