...
// Validate ../../app/api/reset-credits/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/reset-credits">> = Specific
  const handler = {} as typeof import("../../app/api/reset-credits/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
